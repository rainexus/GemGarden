...
public class FileListActivity extends Activity {
	                    ...
	                    switch (which) {
	                        case 0: {
	                        	...
	                        	for(int i=0; i<ffileNames.size(); i++) {
	                        		uris.add(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GiantReturn" + "/image/" + ffileNames.get(i) + ".jpg")));
	                        	}
	                        ...
	                        case 1: {
	                        	...
	                        	ArrayList<Uri> uris = new ArrayList<Uri>();
	                        	for(int i=0; i<ffileNames.size(); i++) {
	                        		uris.add(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GiantReturn" + "/csv/" + ffileNames.get(i) + ".csv")));
	                        	}
	...
	void TryDelete(ArrayList<String> fileNames) {
		...
		.setPositiveButton("OK", new DialogInterface.OnClickListener() {  
            public void onClick(DialogInterface dialog,  
            	...
            	for (int i=0; i<ffileNames.size(); ++i) {
            		{
            			File file = new File(Environment.getExternalStorageDirectory() + "/GiantReturn" + "/image/" + ffileNames.get(i) + ".jpg");
                    	file.delete();
            		}
            		
            		{
            			File file = new File(Environment.getExternalStorageDirectory() + "/GiantReturn" + "/csv/" + ffileNames.get(i) + ".csv");
                    	file.delete();
            		}
            	}
	...
	void ViewImage(String imagefile) {
		...
		intent.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GiantReturn" + "/image/" + imagefile + ".jpg")), "image/*");
	...
	private ArrayList<String> GetFileList() {
		...
		File dir = new File(Environment.getExternalStorageDirectory() + "/GiantReturn/csv/");
	    if (dir.exists()) {
