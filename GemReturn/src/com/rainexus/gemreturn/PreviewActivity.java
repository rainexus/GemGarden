...
public class PreviewActivity extends Activity {
	...
	void SaveImage() {
		File imageFile = new File(Environment.getExternalStorageDirectory() + "/GemReturn" + "/image/" + fileName + ".jpg");  
    	try {
	...
	void SaveCsv() {
		File imageFile = new File(Environment.getExternalStorageDirectory() + "/GemReturn" + "/csv/" + fileName + ".csv");  
    	try {
			imageFile.createNewFile();
			FileOutputStream fos = new FileOutputStream(imageFile);
			// cols
	                ...
	                public void onClick(DialogInterface dialog, int which) {
	                    switch (which) {
	                        case 0: {
	                        	...
	                        	Uri uir = Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GemReturn" + "/image/" + fileName + ".jpg"));
	                        ...
	                        case 1: {
	                        	Intent sharingIntent = new Intent(Intent.ACTION_SEND);
	                        	Uri uir = Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GemReturn" + "/csv/" + fileName + ".csv"));
	                        ...
	                        case 2: {
	                        	...
	                        	uris.add(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GemReturn" + "/image/" + fileName + ".jpg")));
	                        	uris.add(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/GemReturn" + "/csv/" + fileName + ".csv")));
	                        	sharingIntent.setType("plain/text");
